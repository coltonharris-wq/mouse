    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "mouse node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["mouse node status", "Check node host service status."],
          ["mouse node install", "Install the node host service."],
          ["mouse node restart", "Restart the installed node host service."],
