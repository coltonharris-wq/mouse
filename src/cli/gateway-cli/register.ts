      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mouse gateway run", "Run the gateway in the foreground."],
            ["mouse gateway status", "Show service status and probe reachability."],
            ["mouse gateway discover", "Find local and wide-area gateway beacons."],
            ["mouse gateway call health", "Call a gateway RPC method directly."],
