...
${formatHelpExamples([
  ...
  ["mouse agents set-identity --agent main --avatar avatars/openclaw.png", "Set avatar path."],
  [
    "mouse agents set-identity --workspace ~/.openclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "mouse agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main",
