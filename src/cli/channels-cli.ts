    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mouse channels list", "List configured channels and auth profiles."],
          ["mouse channels status --probe", "Run channel status checks and probes."],
          [
            "mouse channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mouse channels login --channel whatsapp", "Link a WhatsApp Web account."],
