    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mouse memory status", "Show index and provider status."],
          ["mouse memory status --deep", "Probe embedding provider readiness."],
          ["mouse memory index --force", "Force a full reindex."],
          ['openclaw memory search "meeting notes"', "Quick search using positional query."],
          [
            'openclaw memory search --query "deployment" --max-results 20',
            "Limit results for focused troubleshooting.",
          ],
          ["mouse memory status --json", "Output machine-readable JSON (good for scripts)."],
