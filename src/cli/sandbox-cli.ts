...
const SANDBOX_EXAMPLES = {
  main: [
    ["mouse sandbox list", "List all sandbox containers."],
    ["mouse sandbox list --browser", "List only browser containers."],
    ["mouse sandbox recreate --all", "Recreate all containers."],
    ["mouse sandbox recreate --session main", "Recreate a specific session."],
    ["mouse sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mouse sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mouse sandbox list", "List all sandbox containers."],
    ["mouse sandbox list --browser", "List only browser containers."],
    ["mouse sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["mouse sandbox recreate --all", "Recreate all containers."],
    ["mouse sandbox recreate --session main", "Recreate a specific session."],
    ["mouse sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mouse sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mouse sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mouse sandbox explain", "Show effective sandbox config."],
    ["mouse sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mouse sandbox explain --agent work", "Explain an agent sandbox."],
    ["mouse sandbox explain --json", "JSON output."],
  ],
} as const;
