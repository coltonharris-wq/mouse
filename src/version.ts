...
declare const __MOUSE_VERSION__: string | undefined;
...
export const VERSION = resolveBinaryVersion({
  ...
  injectedVersion: typeof __MOUSE_VERSION__ === "string" ? __MOUSE_VERSION__ : undefined,
  bundledVersion: process.env.MOUSE_BUNDLED_VERSION,
});
