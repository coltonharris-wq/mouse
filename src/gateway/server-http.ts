...
import { handleChatHttpRequest, type ChatHttpDispatcher } from "./chat-http.js";
import { handleOnboardConfigHttpRequest } from "./onboard-config-http.js";
...
export function createGatewayHttpServer(opts: {
  ...
  /** Optional dispatcher for POST /api/chat requests. */
  chatDispatch?: ChatHttpDispatcher;
  handlePluginRequest?: PluginHttpRequestHandler;
  shouldEnforcePluginGatewayAuth?: (pathContext: PluginRoutePathContext) => boolean;
  resolvedAuth: ResolvedGatewayAuth;
  ...
  async function handleRequest(req: IncomingMessage, res: ServerResponse) {
    ...
    try {
      ...
      const requestStages: GatewayHttpRequestStage[] = [
        ...
        {
          name: "api-onboard-config",
          run: () => handleOnboardConfigHttpRequest(req, res, { resolvedAuth }),
        },
        {
          name: "mouse-root",
          run: () => {
            ...
            sendJson(res, 200, { service: "King Mouse", status: "running" });
            return true;
          },
        },
        {
