...
if (
  ...
  if (shouldForceReadOnlyAuthStore(process.argv)) {
    process.env.MOUSE_AUTH_STORE_READONLY = "1";
  }
  ...
  function ensureExperimentalWarningSuppressed(): boolean {
    ...
    if (isTruthyEnvValue(process.env.MOUSE_NO_RESPAWN)) {
      return false;
    }
    if (isTruthyEnvValue(process.env.MOUSE_NODE_OPTIONS_READY)) {
      return false;
    }
    ...
    process.env.MOUSE_NODE_OPTIONS_READY = "1";
